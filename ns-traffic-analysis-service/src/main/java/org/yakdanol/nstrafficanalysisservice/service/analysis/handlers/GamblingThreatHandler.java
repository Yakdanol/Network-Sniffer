...
public class GamblingThreatHandler implements AnalysisHandler {
    ...
    public void preload() throws IOException, URISyntaxException {
        redis.del(CATEGORY);
        URL path = getClass().getClassLoader().getResource(configs.getRedisConfigs().getDirectory() + "gambling.txt");
