...
public class SocialThreatHandler implements ThreatHandler {
    private final TrafficSecurityConfig configs;
    private static final String CATEGORY = "SOCIAL";
    ...
    public void preload() throws IOException, URISyntaxException {
        redis.del(CATEGORY);
        URL path = getClass().getClassLoader().getResource(configs.getRedisConfigs().getDirectory() + "social-IPs.txt");
