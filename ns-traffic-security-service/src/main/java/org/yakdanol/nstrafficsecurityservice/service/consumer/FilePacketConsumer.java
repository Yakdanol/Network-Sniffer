...
@Service("securityFilePacketConsumer")
public class FilePacketConsumer implements PacketConsumer {
    ...
    public FilePacketConsumer(TrafficSecurityConfig trafficSecurityConfig) {
    ...
    public List<Packet> getPackets() {
        ...
        int batchSize = trafficSecurityConfig.getFileConfigs().getBatchSize();
