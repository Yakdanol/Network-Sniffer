...
public class GamblingThreatHandler implements ThreatHandler {
    private final TrafficSecurityConfig configs;
    private static final String CATEGORY = "GAMBLING";
    ...
    public void preload() throws IOException, URISyntaxException {
        redis.del(CATEGORY);
        URL path = getClass().getClassLoader().getResource(configs.getRedisConfigs().getDirectory() + "gambling-IPs.txt");
